...
/*
 *Esta ventana es para captar la opción de juego del jugador 1
 */
public class Juega1 extends javax.swing.JFrame {

    public Juega1() {
        initComponents();
        this.setLocationRelativeTo(null);//colocar la ventana en el centro
        datos dat = new datos();
        txnombre1.setText(dat.getNombre1()); //coloca el nombre de el jugador en turno  
    ...
    private void initComponents() {
        ...
        txnombre1.setForeground(new java.awt.Color(255, 0, 0));
        txnombre1.setText("----");
        ...
        Iconpiedra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/piedra icono3.jpg"))); // NOI18N
        ...
        Iconpapel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/papel icono3.jpg"))); // NOI18N
        ...
        Icontijera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tijera icono3.jpg"))); // NOI18N
    ...
    private void btdaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btdaleActionPerformed
        datos dat = new datos();        // se captura la selección del jugador 1
        Juega2 jue = new Juega2();
